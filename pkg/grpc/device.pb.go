...
func (x *DevicePingRequest) GetMacAddress() string {
	if x != nil {
		return x.MacAddress
	}
	return ""
...
func (x *DevicePingRequest) GetIpAddress() string {
	if x != nil {
		return x.IpAddress
	}
	return ""
...
func (x *DevicePingResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *DevicePingResponse) GetError() string {
...
var file_device_proto_rawDesc = []byte{
	...
	0x6e, 0x6f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x22, 0x53,
	0x0a, 0x11, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x50, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75,
	...
	0x65, 0x73, 0x73, 0x22, 0x53, 0x0a, 0x12, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x50, 0x69, 0x6e,
	...
	,
...
var file_device_proto_goTypes = []interface{}{
	(*DevicePingRequest)(nil),  // 0: notable.device.DevicePingRequest
	(*DevicePingResponse)(nil), // 1: notable.device.DevicePingResponse
}
var file_device_proto_depIdxs = []int32{
	0, // 0: notable.device.Device.Ping:input_type -> notable.device.DevicePingRequest
	1, // 1: notable.device.Device.Ping:output_type -> notable.device.DevicePingResponse
...
func file_device_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_device_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DevicePingRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_device_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DevicePingResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
